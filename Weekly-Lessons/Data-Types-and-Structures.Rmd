...
```{r}
ftl_example <- read.csv('https://raw.githubusercontent.com/aaronmams/rHD-Data-Wrangling/master/data/ftl_example.csv')
ftl_example
```
...
```{r warnings=F}
vessel_info <- read.csv('https://raw.githubusercontent.com/aaronmams/rHD-Data-Wrangling/master/data/vessel_info.csv')
vessel_info
```
...
```{r}
ftl <- read.csv('https://raw.githubusercontent.com/aaronmams/rHD-Data-Wrangling/master/data/ftl_example.csv')
vessel_info <- read.csv('https://raw.githubusercontent.com/aaronmams/rHD-Data-Wrangling/master/data/vessel_info.csv')
...
2. the dplyr methods to behave more like how I would expect data operators to behave.